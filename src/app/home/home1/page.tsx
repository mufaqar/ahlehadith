...
const Home1 = () => {
  return (
    <>
      ...
      <section className="flex justify-center my-20 py-16 bg-[url('/assets/images/islamic.jpg/')] bg-center bg-no-repeat bg-cover bg-[#fff054] bg-blend-multiply relative before:content-[' '] before:absolute before:top-3 before:bottom-3 before:left-3 before:right-3 before:border-white/50 before:border group">
        <div className="w-3/4 w-full. text-center px-5 bg-white dark:bg-light-gray z-[2]">
